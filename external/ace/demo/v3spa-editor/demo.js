define('v3spa-editor/demo', ['require', 'exports', 'module' , 'ace/lib/fixoldbrowsers', 'ace/multi_select', 'ace/ext/spellcheck', 'ace/config', 'ace/lib/dom', 'ace/lib/net', 'ace/lib/lang', 'ace/lib/useragent', 'ace/lib/event', 'ace/theme/clouds', 'ace/edit_session', 'ace/undomanager', 'ace/keyboard/hash_handler', 'ace/virtual_renderer', 'ace/editor', 'ace/ext/whitespace', 'v3spa-editor/doclist', 'v3spa-editor/layout', 'v3spa-editor/token_tooltip', 'v3spa-editor/util', 'ace/ext/elastic_tabstops_lite', 'ace/incremental_search', 'ace/worker/worker_client', 'ace/split', 'ace/keyboard/vim', 'ace/ext/statusbar', 'ace/ext/emmet', 'ace/snippets', 'ace/ext/language_tools'], function(require, exports, module) {
...
env.editor.setKeyboardHandler(require("ace/keyboard/vim").handler);
env.editor.getSession().setMode("ace/mode/lobster");
...
exports.commands = [{
 ...
 define('v3spa-editor/doclist', ['require', 'exports', 'module' , 'ace/edit_session', 'ace/undomanager', 'ace/lib/net', 'ace/ext/modelist'], function(require, exports, module) {
...
var docs = {
    "docs/example1.lsr": {order: 1, name: "LSR 1"},
    "docs/example2.lsr": {name: "LSR 2", wrapped: true},
    "docs/example3.lsr": {name: "LSR 3", wrapped: true},
    "docs/example4.lsr": {name: "LSR 4", wrapped: true},
    "docs/example5.lsr": {name: "LSR 5", wrapped: true},
    "docs/example6.lsr": {name: "LSR 6", wrapped: true},
    "docs/example7.lsr": {name: "LSR 7", wrapped: true},
    "docs/example8.lsr": {name: "LSR 8", wrapped: true},
    "docs/example9.lsr": {name: "LSR 9", wrapped: true},
    "docs/example10.lsr": {name: "LSR 10", wrapped: true},
    "docs/example11.lsr": {name: "LSR 11", wrapped: true},
    "docs/example12.lsr": {name: "LSR 12", wrapped: true},
    "docs/example13.lsr": {name: "LSR 13", wrapped: true},
    "docs/example14.lsr": {name: "LSR 14", wrapped: true},
    "docs/example15.lsr": {name: "LSR 15", wrapped: true},
    "docs/example16.lsr": {name: "LSR 16", wrapped: true},
    "docs/example17.lsr": {name: "LSR 17", wrapped: true},
    "docs/example18.lsr": {name: "LSR 18", wrapped: true},
    "docs/example19.lsr": {name: "LSR 19", wrapped: true},
    "docs/example20.lsr": {name: "LSR 20", wrapped: true},
    "docs/example21.lsr": {name: "LSR 21", wrapped: true},
    "docs/example22.lsr": {name: "LSR 22", wrapped: true},
    "docs/example23.lsr": {name: "LSR 23", wrapped: true},
    "docs/example24.lsr": {name: "LSR 24", wrapped: true},
    "docs/example25.lsr": {name: "LSR 25", wrapped: true},
    "docs/example26.lsr": {name: "LSR 26", wrapped: true},
    "docs/example27.lsr": {name: "LSR 27", wrapped: true},
    "docs/example28.lsr": {name: "LSR 28", wrapped: true},
    "docs/example29.lsr": {name: "LSR 29", wrapped: true},
    "docs/example30.lsr": {name: "LSR 30", wrapped: true},
    "docs/example31.lsr": {name: "LSR 31", wrapped: true},
    "docs/example32.lsr": {name: "LSR 32", wrapped: true},
    "docs/example33.lsr": {name: "LSR 33", wrapped: true},
    "docs/example34.lsr": {name: "LSR 34", wrapped: true},
    "docs/example35.lsr": {name: "LSR 35", wrapped: true},
    "docs/example36.lsr": {name: "LSR 36", wrapped: true},
    "docs/example37.lsr": {name: "LSR 37", wrapped: true},
    "docs/example38.lsr": {name: "LSR 38", wrapped: true},
    "docs/example39.lsr": {name: "LSR 39", wrapped: true},
    "docs/example40.lsr": {name: "LSR 40", wrapped: true},
    "docs/example41.lsr": {name: "LSR 41", wrapped: true},
    "docs/example42.lsr": {name: "LSR 42", wrapped: true},
    "docs/example43.lsr": {name: "LSR 43", wrapped: true},
    "docs/example44.lsr": {name: "LSR 44", wrapped: true}
};
...
define('v3spa-editor/layout', ['require', 'exports', 'module' , 'ace/lib/dom', 'ace/lib/event', 'ace/edit_session', 'ace/undomanager', 'ace/virtual_renderer', 'ace/editor', 'ace/multi_select', 'ace/theme/textmate'], function(require, exports, module) {
...
define('v3spa-editor/token_tooltip', ['require', 'exports', 'module' , 'ace/lib/dom', 'ace/lib/event', 'ace/range'], function(require, exports, module) {
...
define('v3spa-editor/util', ['require', 'exports', 'module' , 'ace/lib/dom', 'ace/lib/event', 'ace/edit_session', 'ace/undomanager', 'ace/virtual_renderer', 'ace/editor', 'ace/multi_select'], function(require, exports, module) {
